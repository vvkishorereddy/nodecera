            ...
            <div className="row">
              <div className="col-md-12">
                <div className="section">
                  ...
                  <p>
                    Careers Era ("us", "we", or "our") operates the
                    https://www.careersera.com website (hereinafter referred to
                    as the "Service").
                  </p>
                  ...
                  <p>
                    ...
                    Conditions, accessible from https://www.careersera.com
                  </p>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        Service is the https://www.careersera.com website
                        operated by Careers Era
                      </p>
                    </li>
                    <li>
                      <p>
                  ...
                  <p>
                    Careers Era uses the collected data for various purposes:
                  </p>
                  <ul>
                  ...
                  <p>
                    Careers Era will take all steps reasonably necessary to
                  ...
                  <p>
                    Careers Era may disclose your Personal Data in the good
                    faith belief that such action is necessary to:
                  </p>
                  <ul>
                    <li>To comply with a legal obligation</li>
                    <li>
                      To protect and defend the rights or property of Careers
                      Era
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        Statcounter is a web traffic analysis tool. You can read
                        the Privacy Policy for Statcounter here:{" "}
                  ...
                  <ul>
                    <li>
                      ...
                      https://www.careersera.com/contact
                    </li>
                  </ul>
                </div>
              </div>
